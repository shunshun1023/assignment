...
import com.google.android.gms.location.sample.eating.R;
...
public class PoiListItem extends LinearLayout
{
	...
	public void setPoiData(String name, int price, String addr, int stars,
		...
		switch(isBusy){
			case 0:
				this.busy.setImageResource(R.drawable.ic_green);
				System.out.println("BBBB:green");
                break;
            case 1:
                this.busy.setImageResource(R.drawable.ic_yellow);
				System.out.println("BBBB:yellow");
                break;
            case 2:
                this.busy.setImageResource(R.drawable.ic_red);
